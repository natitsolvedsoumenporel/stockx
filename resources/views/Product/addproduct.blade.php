			...
			<div class="main-content">
				<div class="container-fluid">
					<div class="panel panel-profile">
                        <!-- INPUTS -->
                        {{ Form::model($product, array('url' => 'admin/addproductsave','enctype'=> 'multipart/form-data')) }}
                        {{ csrf_field() }}
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                {{ Form::select('subcat_id', array('select subcategory'), null, ['class' => 'form-control', 'id' => 'subcatList']) }}
                                ...
                                <input class="" name="color_id[]" type="checkbox" multiple="multiple" value="{{$color['color_name']}}">{{$color['color_name']}}
                                &nbsp;&nbsp;
                                @endforeach
                                <br>
                                ...
                                <input class="" name="size[]"  class="form-control" type="checkbox" multiple="multiple" value="{{$sizeval['size_number']}}">{{$sizeval['size_number']}}
                                &nbsp;&nbsp;
                                @endforeach
                                </div>
                                <br>
