            ...
            <div class="main-content">
                <div class="container-fluid">
                    <div class="panel panel-profile">
                        <!-- INPUTS -->
                        <?php 
                        $url = 'admin/savecmsedit/'.base64_encode($cms->id);
                        ?>
                        {{ Form::model($cms, array('url' => $url,'enctype'=> 'multipart/form-data')) }}
                        {{ csrf_field() }}
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <input class="" name="status"  id="status" <?php if($cms->status == 1){ ?>checked<?php } ?> type="checkbox">
