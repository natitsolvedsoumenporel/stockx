...
<!--									<li><a href="{{ URL::to('admin/password') }}" class="">Change Password</a></li>-->
						...
						<li>
							<a href="#product" data-toggle="collapse" class="collapsed"><i class="lnr lnr-bookmark"></i> <span>Manage Product</span> <i class="icon-submenu lnr lnr-chevron-right"></i></a>
							<div id="product" class="collapse ">
								<ul class="nav">
									<li><a href="{{ URL::to('admin/listproduct') }}" class="">Product List</a></li>
									<li><a href="{{ URL::to('admin/addproduct') }}" class="">Add Product</a></li>
								</ul>
							</div>
						</li>
